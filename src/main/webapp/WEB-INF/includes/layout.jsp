<%-- /WEB-INF/includes/layout.jsp — Include en todas las vistas internas --%>
...
<header class="app-topbar">
    <a href="${pageContext.request.contextPath}/inicio" class="topbar-logo">
    ...
    <div class="topbar-right">
        ...
        <!-- Cerrar sesión -->
        <a href="${pageContext.request.contextPath}/login?action=logout" class="topbar-btn danger" title="Cerrar sesión">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<aside class="app-sidebar" id="app-sidebar">
    ...
    <div class="sidebar-section">
        ...
        <a href="${pageContext.request.contextPath}/inicio" class="sidebar-link ${currentPage == 'inicio' ? 'active' : ''}">
    ...
    <div class="sidebar-section">
        ...
        <!-- Grupo desplegable -->
        <div class="sidebar-group ${currentPage == 'disponibilidad' || currentPage == 'citas' ? 'open' : ''}" id="citas-group">
            <button class="sidebar-group-toggle" onclick="toggleGrupo('citas-group')">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                Gestión de Citas
                <svg class="toggle-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
...
(function() {
    ...
    // Actualizar estado visual de botones al cargar
    window.addEventListener('DOMContentLoaded', function () {
        actualizarBotonesTema(tema);
        actualizarBotonesFont(fontSize);
        // Abrir grupo si la página actual está dentro
...
function actualizarBotonesTema(tema) {
    ...
    var active = document.getElementById('theme-' + tema);
