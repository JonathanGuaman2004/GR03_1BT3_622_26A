...
<head>
    ...
    <title>Mi Agenda — MediCitas</title>
...
<div class="app-layout">
    <div class="app-main">
        <div class="page-header">
            <h1 class="page-title">Mi agenda de hoy</h1>
            <p class="page-subtitle">
                Bienvenido, <c:out value="${sessionScope.usuarioNom}"/> —
                citas del día en orden cronológico
            </p>
        </div>
