...
<div class="app-layout">
    <div class="app-main">
        <div class="page-header">
            ...
            <p class="page-subtitle">Registro completo de todas tus consultas</p>
        </div>
        ...
        <c:choose>
            <c:when test="${empty historial}">
                <div class="empty-state">
                    ...
                    <p>No tienes citas registradas en el historial.</p>
                </div>
            </c:when>
            <c:otherwise>
                        ...
                        <tbody>
                            <c:forEach var="c" items="${historial}">
                                <tr>
                                    ...
                                    <td><strong><c:out value="${c.paciente.nombre}"/></strong></td>
