...
<head>
    ...
    <style>
        ...
        .form-card {
            ...
            border:1px solid rgba(0,0,0,0.06); max-width:540px;
        }
        .form-label {
    ...
    <div class="app-main">
        ...
        <c:if test="${not empty error}">
            <div class="auth-alert error"
                 style="max-width:540px;margin-bottom:1.25rem;padding:0.85rem 1rem;
        ...
        <div class="form-card">
            <form action="${pageContext.request.contextPath}/paciente/citas"
                  method="post">
                <input type="hidden" name="bloqueId"
                       value="<c:out value='${bloqueId}'/>">

                <div style="margin-bottom:1.25rem;">
                    <label class="form-label" for="motivo">Motivo de consulta</label>
                    <textarea class="form-textarea" id="motivo" name="motivo"
                              rows="5"
                              placeholder="Describe los síntomas o razón de tu consulta. Máximo 500 caracteres."
